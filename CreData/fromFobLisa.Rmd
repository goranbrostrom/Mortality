...
Those with *missing birthdate* in *lisa* are those born 1975 or later (What??). They can be removed.
...
Note, this is just cut from "Mort2/CreateData2/fromFobLisa.Rmd". May need
some editing ...
...
```{r gethislisa}
    ...
    ##fobb$hisclass <- fobb$nyhisclass
    ## Instead
    ##fobb <- group_by(fobb, LINNEID) %>% fill_("hisclass") # Later!
    fobb$id <- fobb$LINNEID
