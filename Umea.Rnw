...
\title{Social inequality in mortality among adults and elderly in
  northern  Sweden 1851--2013\footnote{Seminar June 10, 2017, ICASS, Umeå}
}
...
\begin{frame}{Relative differences, ages 40--64 and 65--89}
  ...
  %\begin{center}
\includegraphics[height = 7.5cm]{figs/slide-cumswstand-1}\includegraphics[height=7.5cm]{figs/slide-cumswold-1}
   %\end{center}
\end{frame}
