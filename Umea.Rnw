...
\title{Long--term perspectives of social inequality in mortality among adults and elderly in
  northern  Sweden 1851--2013\footnote{Session "Health and Mortality in Arctic Populations" at The Ninth International Congress on Arctic Social Sciences (ICASS IX) June 10, 2017, Umeå}
}
...
\begin{itemize}
\item The development of social health inequalities and the role of \emp{health-related behavior} in different phases of the transition (Antonovsky and Omran).
