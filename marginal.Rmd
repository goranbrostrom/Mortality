...
The general pattern and development of mortality resembles that from the younger age group (notice that the comparisons are made with different methods in the two age groups, and the figures are therefore only comparable for the identification of patterns in the development), according to the mean age at death for a 65-year-old shown in Figure \@ref(fig:cumsw2abs). Mean death age among women, as expected, was higher than among men. We find a clear increase in life expectancy, but
