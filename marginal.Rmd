...
Health and Welfare. The LISA data depict the situation at the end of the given year, so the follow-up period is from 1 January to 31 December the next year. Deaths may still occur outside the region, but less frequently than in the Fob case.
...
before 100* for a person aged 65, and the *relative risk of dying before age 65* for a person aged 40, respectively. The reason for using different comparative measures for the two age groups is the fact that mortality is very low in the younger age group compared to the older.
