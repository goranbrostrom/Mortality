...
University. Due to data issues (a great deal of missing data in some variables, for example social class, and additional work required to define the exact geographical areas of analysis) we choose to use Linnaeus data only from 1976 onwards. The study period from 1976 to 2000 is constructed from
...
being a scientific choice, is also a practical one. Social position during working age is defined at around age 40 but defined from the last occupation in working age for the elderly and retired population; i.e. from age 65 until death or last observation.
...
before 100* for a person aged 65, and the *relative risk of dying before age 65* for a person aged 40, respectively. The reason for using different comparative measures for the two age groups is the fact that mortality is very low in the younger age group compared to the older, at least recent periods.
