...
\section{Results, causes 41 \ldots}

<<causes41>>=
load("data/vb.rda")
vb <- cal.window(vb, c(1961, 2001))
x <- substr(vb$ULORSAK, 1, 2)
vb$event <- vb$event & (!is.na(vb$ULORSAK)) & (x %in% "41")
...
%The distribution over time periods.
<<41getske4060>>=
cap1w <-  "Cumulative hazards for HISCLASS by time period, ages 40--64, women, causes 41."
scap1w <-  "Cumulative hazards, ages 40--64, women, causes 41."
cap1m <-  "Cumulative hazards for HISCLASS by time period, ages 40--64, men, causes 41."
scap1m <-  "Cumulative hazards, ages 40--64, men, causes 41."
##
cap12 <- "Total hazard of dying before age 60 for a 40 year old person by HISCLASS and decade, women (top) and men (bottom), causes 41."
scap12 <- "Total hazard by HISCLASS, ages 40--64, causes 41."    
cap12log <- "Total hazard of dying before age 60 for a 40 year old person by HISCLASS and decade, women (top) and men (bottom). The last decades, causes 41."
scap12log <- "Total hazard by HISCLASS, ages 40--64, last years, causes 41."    

cap2w <-  "Cumulative hazards for HISCLASS by time period, ages 65--89, women, causes 41."
scap2w <-  "Cumulative hazards, ages 65--89, women, causes 41."
cap2m <-  "Cumulative hazards for HISCLASS by time period, ages 65--89, men, causes 41."
scap2m <-  "Cumulative hazards, ages 65--89, men, causes 41."
##
cap22 <- "Total hazard of dying before age 90 for a 60 year old person by HISCLASS and decade, women (top) and men (bottom), causes 41."
scap22 <- "Total hazard by HISCLASS, ages 65--89, causes 41."    
cap22log <- "Total hazard of dying before age 90 for a 60 year old person by HISCLASS and decade, women (top) and men (bottom). The last decades, causes 41."
scap22log <- "Total hazard by HISCLASS, ages 65--89, last years, causes 41."    
...
##cat("Women:\n")
drw <- drop1(fitw1, test = "Chisq")
xtable(drw, caption = "Effect of covariates for women 40-64, 1990-2005, causes 41.", label = "tab:liswom")
##round(summary(fitw1)$coef[-(1:13), ], 4)
@

The estimated effect sizes are shown in Figure \ref{fig:liswomfig}

<<41liswomfig, fig.cap = "Effect sizes, women 40-64, 1990-2005, causes 41.", fig.height = 4>>=
source("R/plotWEduc.R")
plotWEduc(fitw1)
@
...
##cat("\nMen:\n")
drm <- drop1(fitm1, test = "Chisq")
xtable(drm, caption = "Effect of covariates for men 40-64, 1990-2005, causes 41.")
##round(summary(fitm1)$coef[-(1:13), ], 4)
dcol <- c("blue", "darkgreen", "darkgreen", "red")
@

<<41lismanfig, fig.cap = "Effect sizes, men 40-64, 1990-2005, causes 41.", fig.height = 4>>=
#source("R/plotWEduc.R")
plotWEduc(fitm1)
@


<<41plotliss1, fig.cap = "Cumulative hazards, ages 40--64, 2002--2013, causes 41.", fig.height = 4>>=
#oldpar <- par(mfrow = c(1, 2))
#plot(fitw1, fn = "cum", col = dcol, main = "Women")
#plot(fitm1, fn = "cum", col = dcol, main = "Men")
#par(oldpar)
...
##cat("Women:\n")
drw2 <- drop1(fitw2, test = "Chisq")
xtable(drw2, caption = "Effect of covariates for women 65-89, 1990-2005, causes 41.", label = "tab:liswom")
##round(summary(fitw1)$coef[-(1:13), ], 4)
@

The estimated effect sizes are shown in Figure \ref{fig:liswomfig}

<<41liswomfig2, fig.cap = "Effect sizes, women 65-89, 1990-2005, causes 41.", fig.height = 4>>=
#source("R/plotWEduc.R")
plotWEduc(fitw2)
@
...
##cat("\nMen:\n")
drm2 <- drop1(fitm2, test = "Chisq")
xtable(drm2, caption = "Effect of covariates for men 65-89, 1990-2005, causes 41.")
##round(summary(fitm1)$coef[-(1:13), ], 4)
dcol <- c("blue", "darkgreen", "darkgreen", "red")
@

<<41lismanfig2, fig.cap = "Effect sizes, men 65-89, 1990-2005, causes 41.", fig.height = 4>>=
#source("R/plotWEduc.R")
plotWEduc(fitm2)
@
