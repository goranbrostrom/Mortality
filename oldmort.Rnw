...
levels(vbTab$hisclass40) <- c("elite", "lowMan", "lowWhiteC", "worker")
levels(vbTab$hisclass60) <- c("elite", "lowMan", "lowWhiteC", "worker")
levels(vbTab$period)[8] <- "1991-2001"
load("data/vb.rda")
vb$period <- factor(vb$period)
levels(vb$hisclass) <- c("elite", "lowMan", "lowWhiteC", "worker")
levels(vb$hisclass40) <- c("elite", "lowMan", "lowWhiteC", "worker")
levels(vb$hisclass60) <- c("elite", "lowMan", "lowWhiteC", "worker")
...
\begin{figure}
\includegraphics[height=19cm]{myfigs/SKEUME}
...
woutp <- plotED.glm(resw, col = scol, logScale = FALSE, relative = TRUE, 
                    ylab = "TMR(65|40)", main = "Women")##, exclude = 5:6)
moutp <- plotED.glm(resm, col = scol, logScale = FALSE, relative = TRUE,
                    ylab = "TMR(65|40)", main = "Men")##, exclude = 5:6)
par(oldpar)
@
...
oldpar <- par(mfrow = c(2, 1))
woutp <- plotED.glm(resw, col = scol, logScale = FALSE, relative = TRUE,
                    ylab = "TMR(90|65)", main = "Women")##, exclude = 5:6)
moutp <- plotED.glm(resm, col = scol, logScale = FALSE, relative = TRUE,
                    ylab = "TMR(90|65)", main = "Men")##, exclude = 5:6)
par(oldpar)
@
...
oldpar <- par(mfrow = c(2, 1))
woutp <- plotED.glm(resw, col = scol, logScale = FALSE, relative = TRUE,
                    ylab = "H(90|65)",  main = "Women")
moutp <- plotED.glm(resm, col = scol, logScale = FALSE, relative = TRUE,
                    ylab = "H(90|65)", main = "Men")
par(oldpar)
@
