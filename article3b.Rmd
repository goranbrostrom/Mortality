...
economic resources, status, social power, etc.  We have chosen to work with a broad definition of classes, merging the original 12 social classes in Hisclass into three, representing different levels of control and access to resources vital for life chances, and an additional fourth category of unknown class:
...
We use the *median remaining life at 65* (reported as median age at death) as the summary measure. Looking at the table below, it is obvious that the statistical significance is still strong.
...
```{r plotrawwom, fig.cap="Median age at death for a 65 year old married woman on the countryside by SES and period.", fig.height = 5, out.height = "10cm"}
x <- c(1812, 1837, 1862, 1887, 1912, 1937, 1975, 1985, 1995, 2004, 2011)
plot(x, med[1, -7], col = scol[1], type = "b", lty = 1, pch = 1, xlab = "Period", ylab = "Median age at death | 65", ylim = c(70, 90), main = "Women", axes = FALSE)
...
legend("bottomright", legend = hc, lty = 1:5, pch = 1:5, col = scol)
```
...
```{r plotrawm, fig.cap="Median age at death for a 65 year old married man on the countryside by SES and period.", fig.height = 5}
x <- c(1812, 1837, 1862, 1887, 1912, 1937, 1975, 1985, 1995, 2004, 2011)
plot(x, med[1, -7], col = scol[1], type = "b", lty = 1, pch = 1, xlab = "Period", ylab = "Median age at death | 65", ylim = c(70, 90), main = "Men", axes = FALSE)
axis(1, at = x, labels = peri[-7], las = 2, cex.axis = 0.5)
axis(2, las = 1)
abline(h = c(75, 80, 85), lty = 3)
box()
