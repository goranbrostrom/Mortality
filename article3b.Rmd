...
plot(x, med[1, -7], col = scol[1], type = "b", lty = 1, pch = 1, xlab = "Period", ylab = "Age", ylim = c(70, 90), main = "Women", axes = FALSE)
axis(1, at = x, labels = peri[-7], las = 2, cex.axis = 0.5)
axis(2, las = 1)
box()
abline(h = c(75, 80, 85), lty = 3)
for (i in 2:5){
    lines(x, med[i, -7], col = scol[i], type = "b", lty = i, pch = i)
}
...
x <- c(1812, 1837, 1862, 1887, 1912, 1937, 1975, 1985, 1995, 2004, 2011)
plot(x, med[1, -7], col = scol[1], type = "b", lty = 1, pch = 1, xlab = "Period", ylab = "Age", ylim = c(70, 90), main = "Men", axes = FALSE)
axis(1, at = x, labels = peri[-7], las = 2, cex.axis = 0.5)
axis(2, las = 1)
abline(h = c(75, 80, 85), lty = 3)
box()
