...
library(knitr)
opts_chunk$set(engine='R',fig.path='figs/art3-',tidy=FALSE,fig.height=6.5,fig.width=8,strip.white=TRUE,cache=FALSE,echo=FALSE,message=FALSE,comment=NA,show.signif.stars = FALSE)##$
library(knitr)
library(eha)
library(xtable)
library(skum)
