...
\begin{abstract}
This version is 'old', but all the code is included, so it will be crystal-clear to the reader exacttly what has been done. 

Spotted errors must pe reported immediately!
...
vb$hisclass40 <- factor(vb$hisclass40, labels = c("1+2", "3+8", "4+5+6", "7+9+10+11+12"))
vb$hisclass60 <- factor(vb$hisclass60, labels = c("1+2", "3+8", "4+5+6", "7+9+10+11+12"))
vb$hisclass <- factor(vb$hisclass, labels = c("1+2", "3+8", "4+5+6", "7+9+10+11+12"))
## End cut ####################################################
