...
Now let us put on emph{partner} on {\bf lisaold}.

<<partner>>=
load("../../Data/partner.rda")
##females <- lisaold[lisaold$sex == "female", ]
##par.fem <- partner[partner$LINNEID1 %in% females$LINNEID | partner$LINNEID2 %in% females$LINNEID2, ]
