...
print(xtable(ex[,,2], label = "tab:womenexp", caption = "Exposure in years by hisclass and period, women.", digits = 0), 
      type = "latex", comment = FALSE)
```

```{r exposuretab2, message = FALSE, cache = FALSE, results = 'asis'}
print(xtable(ex[,,1], label = "tab:menexp", caption = "Exposure in years by hisclass and period, men.", digits = 0), 
      type = "latex", comment = FALSE)
```
...
print(xtable(deaths[,,2], label = "tab:womendeaths", caption = "Number of deaths by hisclass and period, women.", digits = 0), 
      type = "latex", comment = FALSE)
```

```{r deathtab2, message = FALSE, cache = FALSE, results = 'asis'}
print(xtable(deaths[,,1], label = "tab:mendeaths", caption = "Number of deaths by hisclass and period, men.", digits = 0), 
      type = "latex", comment = FALSE)
```