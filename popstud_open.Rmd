---
title: Is high social class always beneficial for survival? A study of northern Sweden 1801--2013 \footnote{Short; "Is high social class beneficial for survival?"} \footnote{Funding:}
...
see Figure \@ref(fig:plottaalla). Corresponding to what we found for men, the
...
Figure 3 is shown as absolute numbers, exposures for women in Table \@ref(tab:womenexp), and exposures for men in Table \@ref(tab:menexp).
...
Then number of deaths for women are shown in Table \@ref(tab:womendeaths), and for men in Table \@ref(tab:mendeaths).
