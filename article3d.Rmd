...
```{r cumsw2, fig.cap = "Excess years of life (compared to 'worker') before 100 for a 65-year-old, by hisclass and period (experimental!).", fig.scap = scap0, fig.height = 8, out.height = "14cm"}
##source("R/plotED.glm.R")
oldpar <- par(mfrow = c(2, 1))
midper <- c(1812.5, 1837.5, 1862.5, 1887.5, 1912.5, 1937.5, 1981, 1991, 2000.5, 2009.5)
mm <- resw[3, ]
plot(midper, resw[1, ] - mm, col = scol[1], type = "b", ylim = c(-4, 5), xlab = "Period", 
...
mm <- resm[3, ]
plot(midper, resm[1, ] - mm, col = scol[1], type = "b", ylim = c(-4, 5), xlab = "Period", 
