...
\item Development over \emp{time}.
  \begin{itemize}
\item Explicit or implicit assumption of an \emp{eternal} social gradient in history in many theories (Omran, Link and Phelan, Marmot, McKeown), some implying even larger in history.
...
\item Antonovsky – large differences in adulthood, convergence in old age
\end{itemize}
\end{itemize}
...
\item[Social class] Elite, middle, worker. Household definition 1851--1950. Individual definition 1976--2013
%\item[*Income] 1986--2005, grouped by quartiles.
%\item[*Education] 1990--2013, three categories.
\item[Period]  1851--1875, \ldots,  2008--2013 (13 periods). 
...
\item \emp{Large} differences between those in working age compared to the retired population, indications of \emp{status convergence}.
...
\includegraphics[height=5cm]{myfigs/Top_incomes}
\end{center}
