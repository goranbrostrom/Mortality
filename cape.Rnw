...
\begin{frame}{Married, rural areas, ages 40--64}
...
\begin{frame}{Married, rural areas, ages 40--64, 1976--2013}
...
\begin{frame}{Married, rural areas, ages 65--89}
...
\begin{frame}{Married, rural areas, ages 65--89, 1976--2013}
...
\item No \emp{qualitative} but partly \emp{quantitative} differences between those in working age compared to the retired population, indications of \emp{status convergence}.
