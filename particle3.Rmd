...
plot(1:13, resw[1, ], type = "b", col = scol[1], axes = FALSE, ylim = c(40, 75), main = "Women", ylab = "Age", xlab = "", xlim = c(1, 15.5))
axis(1, at = 1:13, labels = labb, las = 2)
axis(2, at = c(40, 50, 60, 70), las = 1)
abline(h = c(50, 60, 70), lty = 3)
box()
...
## Men:
plot(1:13, resm[1, ], type = "b", col = scol[1], axes = FALSE, ylim = c(40, 75), main = "Men", ylab = "Age", xlab = "", xlim = c(1, 15.5))
axis(1, at = 1:13, labels = labb, las = 2)
axis(2, at = c(40, 50, 60, 70), las = 1)
box()
